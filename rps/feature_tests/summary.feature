Feature: summary details
    ...
    Background:
        Given the IP has provided the employee details
            ...
            | employee_owed_wages_in_arrears     | 150        |
    ...
    #      And the claimant views the summary page
    #     Then the page should include "The Insolvency Practitioner has suggested 150. Your payment will be calculated using the lower figure of 150"
    #     #TODO:
